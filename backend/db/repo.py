        ...
        out.append(
            {
                ...
                "state": r["state"],
                "slides_total": int(r["slides_total"] or 0),
                "slides_present": int(r["slides_present"] or 0),
                "slides_failed": int(r["slides_failed"] or 0),
                "author": {
                    "id": r["author_id"],
...
def get_post_detail(
    ...
    return {
        ...
        "state": row["state"],
        "slides_total": int(row["slides_total"] or 0),
        "slides_present": int(row["slides_present"] or 0),
        "slides_failed": int(row["slides_failed"] or 0),
        "author": {
            "id": row["author_id"],
